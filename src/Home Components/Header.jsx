...
//             { name: "Services", to: "/services" },
//             { name: "Portfolio", },
//             { name: "Packages", to: "/packages", dropdown: true },
//             // { name: "Blog", to: "/blog" },
//           ].map((item, index) => (
//             <Link
//               onClick={toggleMenu}
...
//                   {item.name}{" "}
//                   { (
//                     <ul className="flex flex-col space-y-2 mt-2 ml-10 text-gray-500">
//                       <Link to="/portfolio">Porfolio Page</Link>
//                       <a href="/Small Portfolio 2025.pdf" download="Marketerra.pdf">Download PDF</a>
//                     </ul>
//                   )}
//                 </span>
//               ) : (
...
const Header = () => {
  ...
  return (
    <header className="bg-black/60 fixed w-full z-50 transition-all duration-300 -mb-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-5 pt-10 lg:h-20 md:h-20 xl:h-20">
      ...
      >
        <nav className="flex flex-col space-y-3">
          ...
          <button
            ...
            className="text-white font-medium py-2 block w-full text-left"
          >
            Portfolio
          </button>
          ...
          {mobilePortfolioOpen && (
            <ul className="flex flex-col space-y-2 -mt-2  ml-6 text-gray-500">
          ...
          >
            ...
            >
              <div className="flex justify-between items-center mb-4">
                ...
                <motion.button whileTap={{ scale: 0.7 }} onClick={closeContactForm}>
                  <FiX className="w-5 h-5 text-gray-300 font-extrabold cursor-pointer" />
                </motion.button>
              </div>
              <div className="flex flex-row items-center gap-2">
                <HiOutlineMail className="text-2xl text-[#2ca378]" />
                <span className="text-sm text-[#2ca378]">marketerraagencyy@gmail.com</span>
              </div>
            </motion.div>
          </motion.div>
        )}
