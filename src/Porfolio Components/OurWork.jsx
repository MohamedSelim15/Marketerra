  ...
  const clients = [
    {
      ...
      imageShadow: ["0 -5px 10px rgba(242, 166, 59, 0.5)","0 5px 10px rgba(242, 166, 59, 0.5)"]
    },
    {
      ...
      imageShadow: ["0 -5px 10px rgba(73, 165, 185, 0.5)","0 5px 10px rgba(73, 165, 185, 0.5)"]
    },
  ...
  return (
    <div className="">
      ...
      {clients.map((client, index) => (
        <div key={index} className="flex flex-col justify-start items-center w-screen mb-10">
          ...
          <div className="flex flex-col xl:flex-row flex-wrap justify-center items-center  gap-10 mt-10 pb-20">
            {client.image.map((img, imgIndex) => (
              <img
                ...
                style={{ boxShadow: client.imageShadow[0], clientColor: client.titleColor }}
                src={img}
                alt=""
              />
